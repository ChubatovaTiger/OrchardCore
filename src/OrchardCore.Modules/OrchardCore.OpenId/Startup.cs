...
public sealed class Startup : StartupBase
{
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services.TryAddEnumerable(ServiceDescriptor.Scoped<IPermissionProvider, Permissions>());
        services.TryAddEnumerable(ServiceDescriptor.Scoped<INavigationProvider, AdminMenu>());
    }
}
...
public sealed class ClientStartup : StartupBase
{
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services.TryAddEnumerable(ServiceDescriptor.Scoped<IRecipeStepHandler, OpenIdClientSettingsStep>());
...
public sealed class ServerStartup : StartupBase
{
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services.TryAddEnumerable(ServiceDescriptor.Scoped<IRecipeStepHandler, OpenIdServerSettingsStep>());
        services.TryAddEnumerable(ServiceDescriptor.Scoped<IRecipeStepHandler, OpenIdApplicationStep>());
        services.TryAddEnumerable(ServiceDescriptor.Scoped<IRecipeStepHandler, OpenIdScopeStep>());
...
public sealed class ValidationStartup : StartupBase
{
    public override void ConfigureServices(IServiceCollection services)
    {
        ...
        services.TryAddEnumerable(ServiceDescriptor.Scoped<IRecipeStepHandler, OpenIdValidationSettingsStep>());
